...
const objectives = [
  ...
  "Creating job opportunities for unemployed youth and supporting government efforts to reduce unemployment with a motto: together, we can make a difference in the lives of those who need it most.",
